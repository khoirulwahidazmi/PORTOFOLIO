  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch all data
        const [personalResponse, educationResponse, certificationsResponse] = await Promise.all([
          axios.get(`${BACKEND_URL}/api/personal`),
          axios.get(`${BACKEND_URL}/api/education`),
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-8">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center p-4 bg-yellow-600/20 border border-yellow-600/30 rounded-lg">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-blue-600/20 border border-blue-600/30 rounded-lg">
                  <div className="text-2xl font-bold text-blue-400">Profesional</div>
                  <div className="text-gray-300 text-sm">HR & Legal</div>
                </div>
                <div className="text-center p-4 bg-purple-600/20 border border-purple-600/30 rounded-lg">
                  <div className="text-2xl font-bold text-purple-400">Terkini</div>
                  <div className="text-gray-300 text-sm">Sertifikat 2025</div>
                </div>
                <div className="text-center p-4 bg-green-600/20 border border-green-600/30 rounded-lg">
                  <div className="text-2xl font-bold text-green-400">Terakreditasi</div>
                  <div className="text-gray-300 text-sm">BNSP & CHRP</div>
                </div>
              </div>
            </div>
          </div>
